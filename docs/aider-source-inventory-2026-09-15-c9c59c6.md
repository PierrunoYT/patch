# Aider source inventory — 2026-09-15 (`c9c59c6`)

## Reproducible boundary

This inventory supports the [current parity audit](aider-parity-audit-2026-09-15-c9c59c6.md).
It compares Patch `c9c59c6157a60ebcaf890dfbf89b845b67bc1e42` with canonical
...
| `aider/editor.py`             | partial            | `src/io/editor.ts`; shell-free temporary draft editing and Windows-safe tokenization are production-wired.                                                                      |
...
| `aider/io.py`                 | partial            | `src/input.ts` and `src/io/**`; Patch's minimal streaming/sanitized terminal is complete, while Rich/Vi/broad controls are non-goals.                                           |
...
| `aider/voice.py`              | partial / non-goal | Optional `@pierrunoyt/patch/voice` embedding helper is implemented; CLI/device UX is a non-goal.                                                                                |
...
semantic equivalence inside a file, detect every interaction, or make the
