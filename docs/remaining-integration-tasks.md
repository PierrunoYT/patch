...
- [ ] Fail closed on publication-check errors during undo.
- [ ] Handle filenames beginning with Git pathspec magic in ignore checks.
- [ ] Reclaim unused process-wide worktree lock entries without splitting locks.
